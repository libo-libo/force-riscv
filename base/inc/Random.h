...
namespace Force {
  ...
  */
  ...
  public:
    ...
    static constexpr result_type min() noexcept { return 0; } //!< min function required by STL
    static constexpr result_type max() noexcept { return MAX_UINT32; } //!< max function required by STL
    result_type operator () () const { return mpRandomInstance->Random32(min(), max()); }
